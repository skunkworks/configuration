...
git_user() {
  ...
  committer=$(git config duet.env.git-committer-initials)
...
export PROMPT='%{$fg_bold[green]%}%m:%{$fg_bold[blue]%}%~%{$fg_bold[green]%}$(git_prompt_info)%{$reset_color%}%#%{$fg_bold[gray]%}%{$reset_color%} '
